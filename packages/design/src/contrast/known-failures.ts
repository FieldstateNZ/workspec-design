...
/**
 * One committed, documented contrast-gate failure: a {@link ContrastPair}
 * (identified by its two tokens) in one theme that measured below its
 * class threshold at the time of the initial audit (2026-07-06). Extraction
 * discipline forbids changing token values to fix these — they're recorded
 * here and in `docs/drift-log.md` for Brett's adjudication instead.
 *
